...
QT_MOC_LITERAL(1, 7, 9), // "appendMsg"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 14) // "updateProgress"

    },
    "Logger\0appendMsg\0\0updateProgress"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->appendMsg((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->updateProgress((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logger::appendMsg)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Logger::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logger::updateProgress)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Logger::appendMsg(const QString & _t1)
{
...
// SIGNAL 1
void Logger::updateProgress(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
